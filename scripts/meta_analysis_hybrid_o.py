...
def hybrid_meta( studies : List[Tuple['Study','VariantData']], is_het_test = False ):
    # meta-analyse non imputed studies with IVW, imputed with ZS, combine the two

    # create vector of non-imputed studies
    #for s in studies:
        #print(s[0].name)
        #print(s[1])
        #print('imputed=', s[1].extra_cols[0])

    return (0.5, 0.001)



SUPPORTED_METHODS = {"n":n_meta,"inv_var":inv_var_meta,"variance":variance_weight_meta,"z":z_meta,"hybrid":hybrid_meta}
