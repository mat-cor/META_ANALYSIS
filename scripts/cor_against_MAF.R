...
typed = fread(paste0(typed_path,"/z_",key,"_",chr,".txt"))

masked = fread(paste0(masked_path,"/z_",key,"_",chr,".txt"))

imputed = fread(paste0(imputed_path,"/z_",key,"_",chr,"_0.0001.txt"))
